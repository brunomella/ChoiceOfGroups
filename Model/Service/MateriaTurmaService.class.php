<?php
require_once '../../../ChoiceOfGroups/Model/DAO/MateriaTurmaDAO.class.php';
require_once '../../../ChoiceOfGroups/Model/Entity/MateriaTurma.class.php';
require_once 'IService.class.php';


class MateriaTurmaService {
	private $_Lista = array();
	private $_DAO = null;

	public function create($class) {
		#Instancia do DAO
		$_DAO = new MateriaTurmaDAO();
		#Chama Metodo Create
